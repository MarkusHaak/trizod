...
The current re-referenced dataset (v0.3.0) is published on Zenodo under the concept DOI [10.5281/zenodo.21309963](https://doi.org/10.5281/zenodo.21309963), which always resolves to the latest version. The previous dataset is at [10.6084/m9.figshare.25792035](https://www.doi.org/10.6084/m9.figshare.25792035).
...
The full re-referenced TriZOD dataset is published on Zenodo (concept DOI [10.5281/zenodo.21309963](https://doi.org/10.5281/zenodo.21309963); latest version v0.3.0), distributed as a single Parquet file. The repository ships [`.zenodo.json`](.zenodo.json) and [`CITATION.cff`](CITATION.cff) describing the deposit.
