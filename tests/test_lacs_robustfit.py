...
X_DATA = np.array(
    [-1.9481, -1.7816, -1.4493, -1.1691, -1.1566, -1.0759, -1.0289, -0.7607,
     -0.7495, -0.5415, -0.4348, -0.3797, -0.168, -0.1459, 0.3484, 0.5317,
     0.7004, 0.7788, 1.1594, 1.1607, 1.2058, 1.3595, 2.0978, 3.0601, 3.0749,
     3.279, 3.3078, 3.5501, 3.6546, 3.7033]
)
Y_DATA = np.array(
    [1.1536, -0.123, 0.0764, -3.2262, -0.8256, 3.6162, 0.2637, 1.8704, 0.3339,
     0.9236, 1.4256, 3.5366, 1.3108, -4.2362, 1.3208, 4.0322, 2.7837, 1.6644,
     2.5819, 2.6773, 2.5274, 2.3252, 3.7062, 5.0906, 4.5135, 2.7373, 4.6041,
     4.5849, 3.6859, 4.5873]
)
